...
## =================================================================
## 2019-08-22 NNbenchmark TEMPLATE FOR AMORE_0.2.15 + algo BATCHgdwm
...
## =================================================
TF      <- TRUE 
descr   <- paste(dset,  "AMORE::train_BATCHgdwm", sep = "_")
nruns   <- 5
method  <- "BATCHgdwm"
iter    <- 9000
...
momentum <- 0.7
stars   <- ""
params  <- "iter=9000, lr=0.008, momentum=0.7, tansig"
comment <- "Bad. No example"
