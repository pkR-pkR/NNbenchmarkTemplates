...
## =======================================================================
## 2019-08-22 NNbenchmark TEMPLATE FOR AMORE AMORE_0.2.15 + algo ADAPTgdwm
...
## =================================================
TF      <- TRUE 
descr   <- paste(dset,  "AMORE::train_ADAPTgdwm", sep = "_")
nruns   <- 10
method  <- "ADAPTgdwm"
iter    <- 10000
...
momentum <- 0.8
stars   <- "*"
params  <- "iter=10000, lr=0.009, momentum=0.8, sigmoid"
comment <- ""
