...
## ==========================================================
## 2019-08-22 NNbenchmark TEMPLATE FOR ANN2_2.3.2 + algo adam
...
## =================================================
TF      <- TRUE 
descr   <- paste(dset,  "ANN2::neuralnetwork_adam", sep = "_")
nruns   <- 10
method  <- "adam"
iter    <- 4000
lr      <- 0.02
stars   <- "*"
params  <- "iter=4000, lr=0.02"
comment <- "Require fine tuning"
