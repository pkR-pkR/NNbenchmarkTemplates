load("D:/GSoC2020/NNbenchmark/data/bNNdatasets.rda")
bWoodN1 <- mWoodN1
save(bWoodN1, compress = "xz", file = "D:/GSoC2020/NNbenchmark/data/bNNdatasets.rda")
...
NNbigdatasets <- list(bWoodN1 = list(ds = "bWoodN1",
                                     neur = 5, nparNN = 41, 
...
save(NNbigdatasets, compress = "xz", file = "D:/GSoC2020/NNbenchmark/data/NNbigdatasets.rda")
