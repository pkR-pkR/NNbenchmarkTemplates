...
NNtrain.automl <- function(x, y, hidden_neur, optim_method, hyperParams, ...) {
...
res <- train_and_predict_1data(1, automl.method, "NNtrain.automl", "hyperParams.automl", "NNpredict.automl", 
                               NNsummary, automl.prepareZZ, nrep=5, echo=TRUE, doplot=FALSE,
...
NNtrain.brnn <- function(x, y, hidden_neur, optim_method, hyperParams,...) {
...
NNtrain.CaDENCE <- function(x, y, hidden_neur, optim_method, hyperParams,...) {
...
res <- train_and_predict_1data(1, CaDENCE.method, "NNtrain.CaDENCE", "hyperParams.CaDENCE", "NNpredict.CaDENCE", 
                               NNsummary, CaDENCE.prepareZZ, nrep=2, echo=TRUE, doplot=FALSE,
...
NNtrain.deepnet <- function(x, y, hidden_neur, optim_method, hyperParams, ...) {
...
res <- train_and_predict_1data(1, CaDENCE.method, "NNtrain.deepnet", "hyperParams.deepnet", "NNpredict.deepnet", 
                               NNsummary, deepnet.prepareZZ, nrep=2, echo=TRUE, doplot=FALSE,
...
methodlist <- list(AMORE.method, automl.method, brnn.method, CaDENCE.method, 
                   deepnet.method, nnet.method)
pkgvect <- c("AMORE", "automl", "brnn", "CaDENCE", "deepnet", "nnet")
funvect <- c("train", "automl_train_manual", "brnn", "cadence.fit", "nn.train", "nnet")
...
preparelist <- list(AMORE.prepareZZ, automl.prepareZZ, brnn.prepareZZ, CaDENCE.prepareZZ,
                    deepnet.prepareZZ, nnet.prepareZZ)
