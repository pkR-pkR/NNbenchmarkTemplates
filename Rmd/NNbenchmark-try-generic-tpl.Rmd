    ...
    for(i in 1:nrep)
    {
        ...
        }else
        {
          if(echo && echoreport > 1)
          {
            ...
            print(do.call(predictFUN, list(tempfit, head(ZZ$x), head(ZZ$xy))))
          }
          Ypred[[i]] <- tryCatch(
...
methodlist <- list(AMORE.method, automl.method, brnn.method, CaDENCE.method, 
                   ...
                   keras.method, MachineShop.method, nnet.method)
pkgvect <- c("AMORE", "automl", "brnn", "CaDENCE", "deepnet", "elmNNRcpp", "ELMR", "h2o",  "keras", "MachineShop", "nnet")
funvect <- c("train", "automl_train_manual", "brnn", "cadence.fit", "nn.train", "elm_train", "OSelm_train", "deeplearning", "fit", "fit", "nnet")
...
preparelist <- list(AMORE.prepareZZ, automl.prepareZZ, brnn.prepareZZ, CaDENCE.prepareZZ,
                    ...
                    keras.prepareZZ, MachineShop.prepareZZ, nnet.prepareZZ)
