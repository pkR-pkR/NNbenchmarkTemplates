---
title: "NNbenchmark | snnR"
author: "Salsabila Mahdi and Akshaj Verma"
output:
    html_document:
        toc: true
        toc_float: true
...
## NN Train Function
```{r}
hyperParams <- function() {
    
    iter <- 1000
    
    params <- paste0("_iter=", iter)
...
NNtrain <- function(x, y) {
    
    hyper_params <- hyperParams()
    
    iter <- hyper_params$iter
    
    NNreg <- snnR::snnR(x = x, y = y, 
                        nHidden = as.matrix(neur), 
                        iteramax = iter)
